...
data:extend {
	{
		...
		minable = {mining_time = 1, result = "factory-1-instantiated", count = 1},
...
data:extend {
	{
		...
		icon_size = 64,
		flags = {"player-creation", "placeable-player"},
		minable = {mining_time = 1, result = "factory-2-instantiated", count = 1},
		max_health = 3500,
...
data:extend {
	{
		...
		icon_size = 64,
		flags = {"player-creation", "placeable-player"},
		minable = {mining_time = 1, result = "factory-3-instantiated", count = 1},
		max_health = 5000,
